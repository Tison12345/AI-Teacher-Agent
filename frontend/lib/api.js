...
export const skipCompletion = (sessionId) =>
  request('POST', `/weekly/${sessionId}/skip`)

export const skipToDashboard = (sessionId) =>
  request('POST', `/weekly/${sessionId}/skip-to-dashboard`)
